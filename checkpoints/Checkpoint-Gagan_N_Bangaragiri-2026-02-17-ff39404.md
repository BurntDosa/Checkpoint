...
### Git Hook Installer
- **Development Mode Detection**: Added `repo_root` parameter to detect local development environments and run `main.py` directly.
- **Dynamic Command Generation**: Hook templates now use f-strings to inject the correct command based on the environment.
